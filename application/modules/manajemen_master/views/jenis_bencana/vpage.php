                        ...
                        <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblList" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="33%" class="font-weight-bold">Jenis Bencana</th>
                                    <th width="10%" class="font-weight-bold">Create By</th>
                                    <th width="10%" class="font-weight-bold">Create Date</th>
    ...
    <div class="modal-dialog modal-lg" id="frmEntry">
        <div class="modal-content">
            <div class="modal-header aqua-gradient-rgba">
                <h4 class="modal-title heading lead white-text font-weight-bold"><i class="fas fa-edit"></i> Form Entri Data Jenis Bencana</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-row mb-3">
                    <div class="col-12 col-md-6 required">
                        <label for="nm_bencana" class="control-label font-weight-bolder">Jenis Bencana <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="nm_bencana" id="nm_bencana" placeholder="Jenis Bencana" value="<?php echo $this->input->post('nm_bencana', TRUE); ?>" required>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="col-md-6 col-6 required">
