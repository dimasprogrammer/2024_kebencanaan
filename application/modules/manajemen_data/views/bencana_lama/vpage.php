                        ...
                        <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblList" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="10%" class="font-weight-bold">Data Kejadian</th>
                                    <th width="10%" class="font-weight-bold">Korban Jiwa</th>
                                    <!-- <th width="10%" class="font-weight-bold">Kerusakan</th> -->
                                    <!-- <th width="10%" class="font-weight-bold">Ternak</th> -->
                                    <!-- <th width="10%" class="font-weight-bold">Bantuan</th> -->
                                </tr>
                            </thead>
                        </table>
                    </div>
