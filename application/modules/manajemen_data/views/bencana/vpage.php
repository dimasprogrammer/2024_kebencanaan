                        ...
                        <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblList" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="10%" class="font-weight-bold">Jam Bencana</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-row mb-3">
                    ...
                    <div class="col-12 col-md-6 required">
                        <label for="id_users" class="control-label font-weight-bold">OPD Penanggung Jawab <span class="text-danger">*</span></label>
...
<div class="modal fade" id="modalEntryFormShare" tabindex="-1" role="dialog" aria-labelledby="modalEntryLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" id="frmEntryShare">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(site_url(isset($siteUri) ? $siteUri . '/createShare' : ''), array('id' => 'formEntry', 'class=' => 'needs-validated', 'novalidate' => '')); ?>
            <div class="modal-body">
                <div id="errEntry"></div>
                <?php echo form_input('tokenId', ''); ?>
                <div class="form-row mb-3">
                    <div class="col-12 col-md-6 required">
                        <label for="token_bencana_share" class="control-label font-weight-bold"> Token <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="token_bencana_share" id="token_bencana_share" placeholder="Nama Bencana" required>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
