    ...
    <div class="modal-dialog modal-xxl" id="frmEntryFoto">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-row mb-3">
                    <div class="col-12 col-md-6 required">
                        <label for="title_foto" class="control-label font-weight-bold"> Nama File</label>
                        <input type="text" class="form-control" name="title_foto" id="title_foto" placeholder="Video Bencana" required>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="col-12 col-md-6 required">
                        <label for="nama_file_bencana" class="control-label font-weight-bold">Foto Bencana</label>
                        <div class="custom-file">
                            <input type="file" class="customFile" name="nama_file_bencana" id="nama_file_bencana">
                            <label class="custom-file-label" for="nama_file_bencana"> </i>Silahkan Pilih File</label>
                        </div>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 text-center required">
                        <button type="submit" class="btn btn-primary waves-effect waves-light px-3 py-2 font-weight-bold" name="saveHargaIkan" id="saveHargaIkan"><i class="fas fa-check"></i> Simpan Data </button>
                    </div>
                </div>
                ...
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <div class="card">
                            ...
                            <div class="card-body text-center px-4 mb-3">
                                <table class="table table-striped table-border table-hover table-sm" width="100%" id="tblHargaIkan">
