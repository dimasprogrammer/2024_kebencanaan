                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number" class="form-control form-control-sm text-right" onfocus="resetValueOnClick(this)" onfocusout="restoreValueOnClick(this)"
                                                                            value="0" min="0" name="rusak_berat[<?= $list->id_jenis_sarana ?>]" id="rusak_berat-<?= $list->id_jenis_sarana ?>" 
                                                                        required> 
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" class="form-control form-control-sm text-right" onfocus="resetValueOnClick(this)" onfocusout="restoreValueOnClick(this)"
                                                                            value="0" min="0" name="rusak_sedang[<?= $list->id_jenis_sarana ?>]" id="rusak_sedang-<?= $list->id_jenis_sarana ?>" 
                                                                        required> 
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" class="form-control form-control-sm text-right" onfocus="resetValueOnClick(this)" onfocusout="restoreValueOnClick(this)"
                                                                            value="0" min="0" name="rusak_ringan[<?= $list->id_jenis_sarana ?>]" id="rusak_ringan-<?= $list->id_jenis_sarana ?>" 
                                                                            required> 
                                                                    </td>
                                                                </tr>
                                                            <?php
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number" class="form-control form-control-sm text-right" onfocus="resetValueOnClick(this)" onfocusout="restoreValueOnClick(this)"
                                                                            value="0" min="0" name="jml_terendam[<?= $list->id_jenis_sarana ?>]" id="jml_terendam-<?= $list->id_jenis_sarana ?>" 
                                                                        required> 
                                                                    </td>
                                                                </tr>
                                                            <?php
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php $no_urut = 0;
                                                                ...
                                                                ?>
                                                                    <td>
                                                                        <input type="number" class="form-control form-control-sm text-right" onfocus="resetValueOnClick(this)" onfocusout="restoreValueOnClick(this)"
                                                                            value="0" min="0" name="jml_sarana_lainnya[<?= $list->id_jenis_sarana ?>]" id="jml_sarana_lainnya-<?= $list->id_jenis_sarana ?>" 
                                                                        required> 
                                                                    </td>
                                                                <?php
                                                            endforeach; ?>
