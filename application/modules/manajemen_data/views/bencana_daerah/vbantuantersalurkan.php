                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control form-control-sm text-right" 
                                                ...
                                                value="0" min="0" name="jumlah_bantuan[<?= $list->id_jenis_bantuan ?>]" id="jumlah_bantuan-<?= $list->id_jenis_bantuan ?>" 
                                            required>
                                        </td>
                                    </tr>
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control form-control-sm text-right" 
                                                ...
                                                name="jumlah_sumber[<?= $list->id_jenis_bantuan ?>]" id="jumlah_sumber-<?= $list->id_jenis_bantuan ?>" 
                                            required>
                                        </td>
                                    </tr>
                                <?php
