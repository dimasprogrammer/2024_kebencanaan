            ...
            if (isset($session)) {
                ...
                foreach ($dataList as $key => $dl) {
                    ...
                    if ($dl['id_status'] == 0) {
                        ...
                        <a type="button" data-id="' . $dl['token_bencana'] . '" class="btn btn-grey btn-sm px-2 waves-effect waves-light btnFoto" title="Add Foto">
                        <i class="fas fa-paper-plane"></i> Add Foto
                        </a>
                        <a type="button" data-id="' . $dl['token_bencana'] . '" class="btn btn-grey btn-sm px-2 waves-effect waves-light btnFoto" title="Add Foto">
                        <i class="fas fa-paper-plane"></i> Add Video
                        </a>
