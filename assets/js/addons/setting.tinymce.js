...
tinymce.init({
    ...
    plugins: [
        ...
        'save searchreplace spellchecker tabfocus table template textpattern toc visualblocks visualchars wordcount'
    ],
...
tinymce.init({
    selector: "textarea#rancang_perbaikan",
    height: 500,
    plugins: [
        'advlist anchor autolink charmap code codesample directionality emoticons fullscreen',
        'hr image importcss insertdatetime link lists media nonbreaking pagebreak paste preview print',
...
tinymce.init({
    selector: "textarea#tentang_surat",
    height: 500,
    plugins: [
        'advlist anchor autolink charmap code codesample directionality emoticons fullscreen',
        'hr image importcss insertdatetime link lists media nonbreaking pagebreak paste preview print',
...
tinymce.init({
    selector: "textarea#data_pendukung",
    height: 500,
    plugins: [
        'advlist anchor autolink charmap code codesample directionality emoticons fullscreen',
        'hr image importcss insertdatetime link lists media nonbreaking pagebreak paste preview print',
